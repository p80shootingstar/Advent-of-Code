...
def nombre_mini_cubes_necessaires(game):
    """Renvoie le produit des nombres de cubes rouges, verts et bleus minimums
    necessaires a la constitution du jeu passe en argument.
    Renvoie le resultat sous la forme d'un entier."""

    liste_jeu=analyse_jeu(game)
    liste_mini=[0,0,0] # [r_mini,g_mini,b_mini]

    for tirage in liste_jeu:
        for indice in range(3):
            if tirage[indice]>liste_mini[indice]:
                liste_mini[indice]=tirage[indice]

    return liste_mini[0]*liste_mini[1]*liste_mini[2]

#print(nombre_mini_cubes_necessaires(game1))
#print(nombre_mini_cubes_necessaires(game2))
#print(nombre_mini_cubes_necessaires(game3))
#print(nombre_mini_cubes_necessaires(game4))
#print(nombre_mini_cubes_necessaires(game5))       
...
def traitement_input(fichier):
    ...
    for jeu in liste_input:
        liste_resultats.append(nombre_mini_cubes_necessaires(jeu[0]))
